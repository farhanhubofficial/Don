...
import AboutImage from '../Images/img1.avif'
...
<p>
FRONTEND Store is the destination for the creative community looking for the right textures and feeling for their living spaces. We are also considered interior designer’s first choice in Nakuru Kenya for curtains and fabrics.
